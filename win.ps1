...
& {
    ...
    try {
        ...
        $allowedPath = '^/Tac-9-Pc-Optimizations/TaC9-PC-Optimization-Suite-V2/releases/download/(?:v\d+(?:\.\d+){2,3}/TaC9-PC-Optimization-Suite-V2\.exe|v13\.0\.9/TaC9-PC-Optimization-Suite-V3-r[123456789]\.exe|v13\.0\.10/TaC9-PC-Optimization-Suite-V3-r1\.exe)$'
